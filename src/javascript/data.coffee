module.exports =
  Norway:
    ...
    text: "Rich: In line, Caity fretted over ordering both the school bread and the berry cream puff. “Is it too much?” you asked. Before I could answer, a female patron in line behind us piped up: “You’re at Disney. It’s not too much.”"
  ...
  Mexico:
    ...
    text: "Caity: I got a Wild Passionfruit Margarita and that’s how it made me feel! I give the Wild Passionfruit Margarita one hundred out of one hundred stars, winking and twinkling in perpetual twilight."
  ...
  Test:
    ...
    text: "Rich: That was exciting! Would rain cause us to skid off the road and crash into the neon-framed, Tron-inspired environment? Maybe! Would a giant truck end our lives right there and then in Epcot? Perhaps!"
  ...
  Ellen:
    ...
    text: "Rich: This “ride” is mostly a movie in a theater. It stars Ellen DeGeneres, Bill Nye, and Jamie Lee Curtis and debuted in 1996. That was before Ellen was out. Both she and Curtis are less butch in the footage than they are nowadays."
  ...
  Spaceship:
    ...
    text: "Caity: I could not believe how lifelike the features and movements of the animatronic figures were. I would say they are about 85% of the way to being indistinguishable from humans. Ten years from now, I predict it will be truly terrifying..."
  ...
  Living:
    ...
    text: "Caity: I was so worried I was going to get kicked out of the park that I made a point to gesticulate wildly for the rest of the ride so that, if confronted, I could argue “Hey, that’s just the way I talk—with my hands! Check the surveillance video.”"
  ...
  Circle:
    ...
    text: "Rich: At this point in our trip, I was hopeful that I still might learn something. Simba seemed like he was going to approach the topic of why dams are bad, which is something I’ve been meaning to get around to learning myself."
  ...
  Journey:
    ...
    text: "Rich: Of all of the Here-Are-Some-Scientific-Notions-That-Exist-And-That’s-All-We’re-Saying-About-That attractions at Epcot, Journey Into Imagination with Figment is the absolute dumbest."
  ...
  UK:
    ...
    text: "Caity: All of a sudden, the Rose & Crown chef was on the scene: a big, friendly (American) man in a chef’s outfit of such sparkling white I wondered whether he was simply an actor. It was like Santa had swung by the workshop unannounced."
  ...
  Innoventions:
    ...
    text: "Caity: The Sum of All Thrills was terrifying to behold and fun to experience. The best kept secret in Epcot, and possibly the entire world (because who would ever think to look for something of worth inside Epcot?)."
  ...
  Drinking:
    ...
    text: "Rich: Inside China's giant store, I was tempted by Chinese ghost stories, giant fans to take with me to the club, and an incense burner with a dragon gazing into a crystal ball. I was drunk enough to very much consider buying that last object."
  ...
  Adventure:
    ...
    text: "Caity: The primary thing I remember about the funnel cake is that I was British.<br>
  ...
  China:
    ...
    text: "Rich: At this point, I didn’t care. I was ready to just walk away. “Well, we tried. Tastes disappointing, but isn’t that life?”<br>
  ...
  Japan:
    ...
    text: "Caity: When our waitress brought the bill, she also placed a small pink origami bird on the table. “I made you origami,” she said. She did not make the French Canadians origami, perhaps because they had spilled Diet Coke."
